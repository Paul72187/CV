...
| **Makers Group Project - Anti-Social Media Inc. (Acebook)** | A website clone of Facebook, allowing users to sign up, post a message, like and comment on a message. | Ruby On Rails HTML, JavaScript, CSS, Heroku | https://github.com/Paul72187/acebook-anti-social-media-inc
